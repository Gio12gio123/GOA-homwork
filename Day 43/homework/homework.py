...
temple = "hello {0}. welcome to {1}.".format(name, place)
...
# Use the upper() function to convert the entire string to uppercase. Store the result in a variable named uppercase_greeting and 
# print it.
